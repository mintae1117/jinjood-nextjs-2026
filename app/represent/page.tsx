...
import { getMenuItemsServer } from "@/services/products.server";
import RepresentListClient from "./RepresentListClient";
 ...
 */
export default async function RepresentListPage() {
  ...
  return (
    <>
      ...
      <RepresentListClient initialItems={items ?? undefined} />
    </>
  );
}
