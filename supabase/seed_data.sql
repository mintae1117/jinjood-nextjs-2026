...
('콩시루', 32000, '국산 노란 콩을 사용하여 적절한 멥쌀과 찹쌀의 비율로 제수용으로 최고의 떡! (1되/40개입)', '/images/menu/menu012.avif', 'mepssaltteok', ARRAY['추천'], false, true, false, 12),
('가래떡', 20000, '해남 메뚜기 쌀만을 사용하여 쫀득 말랑한 식감의 떡! 구워서 꿀이나 설탕에 찍어먹으면 더욱 꿀맛! (1되/2.5kg)', '/images/menu/menu013.avif', 'mepssaltteok', ARRAY['추천', '인기'], true, true, false, 13),
...
('모찌', 45000, '쫄깃한 찹쌀 피에 직접 만들어 배합한 팥앙금이 일품!! 수능선물로 최고에요!! (1되/36개입)', '/images/menu/menu023.avif', 'chapssaltteok', ARRAY['인기', '베스트'], true, false, true, 23),
('두텁', 50000, '임금님께 진상하던 귀한 떡! 여러가지 견과류가 기피앙금과 함께 들어가 고급스러운 맛! (16개입)', '/images/menu/menu024.avif', 'chapssaltteok', ARRAY['추천'], false, true, false, 24),
('영양찰밥', 60000, '수수, 조, 밤, 콩, 땅콩, 잣, 검은깨 등등 여러가지 재료가 들어간 대보름 인기최고 제품! (20개입)', '/images/menu/menu031.avif', 'chapssaltteok', ARRAY['인기'], true, false, false, 31),
...
('떡케이크 3~5호', 35000, '생일, 칠순, 팔순등 행사용 떡케이크! 케이크 호수 증가에 따라 5,000원씩 추가 됩니다! (35,000원 ~ 45,000원)', '/images/menu/daprae/ready01.png', 'gift_set', ARRAY['떡케이크'], 6);
...
('떡국세트 1호', 20000, '백미떡국 550g * 1팩, 색깔떡국 550g * 1팩으로 구성된 떡국떡 선물세트!', '/images/menu/giftset/giftset06.avif', 'songpyeon_set', ARRAY['백미떡국 550g 1팩', '색깔떡국 550g 1팩'], 9),
...
-- 백일/돌 세트
INSERT INTO gift_sets (name, price, description, image_url, category, items, display_order) VALUES
('백일&돌세트 1호', 70000, '(百/첫돌)무늬 백설기 27개(꿀추가 선택가능), 오색손송편 1kg, 수수팥떡 1kg', '/images/menu/daprae/ready01.png', 'baekil_dol_set', ARRAY['무늬 백설기 27개', '오색손송편 1kg', '수수팥떡 1kg'], 11),
...
('답례품 1호', 3700, '(百/첫돌)무늬 백설기, 손송편 두알, 수수팥떡 두알이 들어간 가장 기본적인 답례품! (2구)', '/images/menu/daprae/daprae02_01.avif', 'daprye', 1),
('답례품 2호', 3400, '종합무늬 꿀백설기, 단호박편이 한개씩 들어간 기본적인 답례선물용 2구세트!! (2구)', '/images/menu/daprae/daprae02_02.avif', 'daprye', 2),
('답례품 3호', 4600, '꿀백설기, 단호박편, 흑미모둠이 한개씩 들어간 기본적인 답례선물용 3구세트!! (3구)', '/images/menu/daprae/daprae03_01.avif', 'daprye', 3),
('답례품 4호', 5900, '꿀백설기, 대추떡, 단호박편, 흑미모둠이 한개씩 들어간 답례선물용 4구세트!! (4구)', '/images/menu/daprae/ready01.png', 'daprye', 4),
('답례품 5호', 7500, '꿀백설기, 흑미모둠, 단호박편, 통녹두완두찰시루, 약밥이 한개씩 들어간 답례품 (5구)', '/images/menu/daprae/daprae05_01.avif', 'daprye', 5);
